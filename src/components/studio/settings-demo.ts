...
export const DEMO_ACCOUNTS: ConnectedAccount[] = [
  { id: 1, tenant_id: 1, network: "threads", threads_user_id: "t1", username: "mara.lin", display_name: "Mara Lin", profile_picture_url: null, connected_at: "2026-01-04T00:00:00Z", disconnected_at: null, ...SYNCED },
  { id: 2, tenant_id: 1, network: "threads", threads_user_id: "t2", username: "field.notes", display_name: "Field Notes", profile_picture_url: null, connected_at: "2026-02-10T00:00:00Z", disconnected_at: null, ...SYNCED },
  { id: 3, tenant_id: 1, network: "threads", threads_user_id: "t3", username: "studio.mara", display_name: "Studio Mara", profile_picture_url: null, connected_at: "2026-03-12T00:00:00Z", disconnected_at: null, ...SYNCED },
];
