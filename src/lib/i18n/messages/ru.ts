...
export const ru: Partial<Record<MessageKey, string>> = {
  ...
  "studio.remove_gif": "Убрать GIF",
  "studio.gif_powered": "На основе Tenor",
  "studio.gif_excl": "GIF нельзя совмещать с картинками",
  "studio.gif_search": "Поиск в Tenor",
  "studio.gif_close": "Закрыть",
  "studio.gif_searching": "Поиск…",
  "studio.gif_no_results": "Ничего не найдено — попробуй иначе",
  "studio.gif_hint": "Начни вводить для поиска Tenor",
