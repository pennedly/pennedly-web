...
export const ru: Partial<Record<MessageKey, string>> = {
  ...
  "style_rules.intro_lead":
    "Каждый пост и ответ Pennedly проходит через них. Включи встроенные фиксы, которые убирают приметы машинного текста, и добавь свои правила простыми словами.",
