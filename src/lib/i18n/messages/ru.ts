...
export const ru: Partial<Record<MessageKey, string>> = {
  ...
  "scenarios.subtitle": "Повторяющийся или условный контент в твоём голосе — когда → если → сгенерировать, с инструкцией поверх голоса.",
  ...
  "scenarios.empty_sub": "Сценарий генерирует пост или ответ по расписанию, с инструкцией поверх голоса. Начни с шаблона:",
  "scenarios.create": "Создать сценарий",
  "scenarios.error": "Не удалось загрузить сценарии",
  "scenarios.retry": "Повторить",
  "scenarios.pick_title": "Выбери шаблон",
  "scenarios.choose": "Выбрать",
  "scenarios.soon": "скоро",
  "scenarios.tpl.promo": "Акция",
  "scenarios.tpl.promo_desc": "Просишь что-то в комментах → присылаешь отклик в ответ. Розыгрыши, лид-магниты, мини-разборы.",
  "scenarios.tpl.custom": "Свой",
  "scenarios.tpl.custom_desc": "Полный контроль над схемой когда / если / сгенерировать / инструкция. Для нестандартного.",
  "scenarios.tpl.rubric": "Рубрика",
  "scenarios.tpl.rubric_desc": "Регулярный формат по расписанию — «карта дня», «совет недели».",
  "scenarios.tpl.seasonal": "Сезонное",
  "scenarios.tpl.seasonal_desc": "Привязка к датам и сезонам — праздники, годовщины, начало сезона.",
  "scenarios.sec.what": "Что за акция",
  "scenarios.sec.when": "Когда запускать",
  ...
  "scenarios.preview": "Предпросмотр",
  "scenarios.preview_empty": "Предпросмотр появится здесь по мере заполнения полей.",
  "scenarios.preview_cta": "Собранный призыв",
  "scenarios.preview_reply": "Пример отклика",
