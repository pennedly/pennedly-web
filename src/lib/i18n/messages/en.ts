...
export const en = {
  ...
  "style_rules.intro_lead":
    "Every post and reply Pennedly writes runs through these. Switch on the built-in fixes that strip the tells of machine writing, then add your own rules in plain words.",
