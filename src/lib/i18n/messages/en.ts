...
export const en = {
  ...
  "scenarios.warn_morning": "{n} post scenarios target the morning — only one fires, in order. Raise the cap or spread them out. ({names})",
  "scenarios.warn_promo": "A campaign every day is a lot — better ≤2×/week.",
  "scenarios.autopost_off": "Auto-posting is off",
  "scenarios.autopost_off_sub": "Scenarios will prepare drafts but won't publish until auto-posting is on.",
  "scenarios.autopost_on": "Turn on auto-posting",
