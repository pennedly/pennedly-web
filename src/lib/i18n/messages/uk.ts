...
export const uk: Partial<Record<MessageKey, string>> = {
  ...
  "studio.remove_gif": "Прибрати GIF",
  "studio.gif_powered": "На основі Tenor",
  "studio.gif_excl": "GIF не можна поєднати із зображеннями",
  "studio.gif_search": "Пошук у Tenor",
  "studio.gif_close": "Закрити",
  "studio.gif_searching": "Пошук…",
  "studio.gif_no_results": "GIF не знайдено — спробуй інакше",
  "studio.gif_hint": "Почни вводити для пошуку Tenor",
