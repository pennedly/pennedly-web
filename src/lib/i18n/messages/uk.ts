...
export const uk: Partial<Record<MessageKey, string>> = {
  ...
  "scenarios.pick_title": "Обери шаблон",
  "scenarios.choose": "Обрати",
  "scenarios.soon": "скоро",
  "scenarios.tpl.promo": "Акція",
  "scenarios.tpl.promo_desc": "Проси щось у коментарях → надсилай винагороду у відповідь. Розіграші, лід-магніти, міні-розбори.",
  "scenarios.tpl.custom": "Власний",
  "scenarios.tpl.custom_desc": "Повний контроль над схемою коли / якщо / згенерувати / інструкція. Для всього нестандартного.",
  "scenarios.tpl.rubric": "Рубрика",
  "scenarios.tpl.rubric_desc": "Регулярний формат за розкладом — «карта дня», «порада тижня».",
  "scenarios.tpl.seasonal": "Сезонне",
  "scenarios.tpl.seasonal_desc": "Прив’язане до дат чи сезонів — свята, річниці, початок сезону.",
  "scenarios.sec.what": "Про що акція",
  "scenarios.sec.when": "Коли запускати",
