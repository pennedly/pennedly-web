...
export const fr: Partial<Record<MessageKey, string>> = {
  ...
  "scenarios.pick_title": "Choisis un modèle",
  "scenarios.choose": "Choisir",
  "scenarios.soon": "bientôt",
  "scenarios.tpl.promo": "Promo",
  "scenarios.tpl.promo_desc": "Demande quelque chose à ton audience en commentaire → envoie une récompense en réponse. Jeux-concours, lead magnets, mini-lectures.",
  "scenarios.tpl.custom": "Personnalisé",
  "scenarios.tpl.custom_desc": "Contrôle total du modèle quand / si / générer / consigne. Pour tout ce qui sort de l’ordinaire.",
  "scenarios.tpl.rubric": "Série",
  "scenarios.tpl.rubric_desc": "Un format régulier selon un planning — « carte du jour », « conseil de la semaine ».",
  "scenarios.tpl.seasonal": "Saisonnier",
  "scenarios.tpl.seasonal_desc": "Lié à des dates ou des saisons — fêtes, anniversaires, débuts de saison.",
  "scenarios.sec.what": "En quoi consiste la promo",
  "scenarios.sec.when": "Quand l’exécuter",
