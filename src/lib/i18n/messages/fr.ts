...
export const fr: Partial<Record<MessageKey, string>> = {
  ...
  "studio.remove_gif": "Retirer le GIF",
  "studio.gif_powered": "Propulsé par Tenor",
  "studio.gif_excl": "Un GIF ne peut pas être combiné avec des images",
  "studio.gif_search": "Rechercher sur Tenor",
  "studio.gif_close": "Fermer",
  "studio.gif_searching": "Recherche…",
  "studio.gif_no_results": "Aucun GIF trouvé — essaie autre chose",
  "studio.gif_hint": "Tape pour rechercher sur Tenor",
