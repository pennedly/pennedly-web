...
// Restyled 1:1 to design-export/PennedlyDesign/landing-* : a calm marketing
// page at the root of app.pennedly.com — top bar (brand · theme toggle ·
// Sign in), a hero with a tilted "draft specimen" card, a four-up feature row,
// and a legal footer. No app shell, no i18n provider on this public route —
// copy is the EN baseline (the design ships no language switcher here). Built
// on the same ink-on-paper tokens as the app.
