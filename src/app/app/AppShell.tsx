...
//
// Split out of layout.tsx (which wraps this) because `metadata` can only be
// exported from a Server Component — this one needs `"use client"` for its
// hooks (usePathname, useSyncExternalStore, ...), so the metadata export
// (incl. the `/app` tree's noindex) lives in the server layout instead.
//
