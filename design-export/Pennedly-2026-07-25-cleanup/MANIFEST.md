...
1. **`system/Legal Template.html` технически завязан на удаляемый React-слой** — ему нужны legal-app.jsx, legal-data.jsx, legal-icons.jsx, legal-parts.jsx и legal.css, а все пять по условию уходят в To Delete. Файл положен в `system/`, как вы просили, а его ссылки переписаны на новое место этих пяти файлов внутри `To Delete/` — сейчас документ открывается как раньше. Но после удаления папки он станет пустым. Либо вернуть эти пять файлов из To Delete, либо переписать шаблон как обычную спеку.
2. **`Landing.html` и `Onboarding.html` добавлены в To Delete по моей инициативе** — в вашем списке было 13 загрузчиков, эти два в него не попали, но они того же слоя (тянут landing-app.jsx / onboarding-app.jsx и остальную React-обвязку).
3. **`uploads/`** — 15 ваших скриншотов. Отправил в To Delete как рабочие источники; если это архив, верните папку.

## Ссылки на прошлые поколения

Живые документы, которые ссылаются внутрь `To Delete/`. Сейчас все эти ссылки рабочие — файлы физически на месте. **После удаления папки их надо будет вычистить руками**, других битых ссылок в проекте нет.

| Живой документ | Ссылается на |
|---|---|
| `system/Legal Template.html` | `To Delete/legal.css` |
| `system/Legal Template.html` | `To Delete/tweaks-panel.jsx` |
| `system/Legal Template.html` | `To Delete/studio-icons.jsx` |
| `system/Legal Template.html` | `To Delete/legal-icons.jsx` |
| `system/Legal Template.html` | `To Delete/legal-data.jsx` |
| `system/Legal Template.html` | `To Delete/legal-parts.jsx` |
| `system/Legal Template.html` | `To Delete/legal-app.jsx` |
| `components/Autopilot-Reply-Card-SPEC.html` | `To Delete/Scenarios-SPEC.html` |
| `components/Autopilot-Reply-Card-SPEC.html` | `To Delete/Scenario-Editor-SPEC.html` |
| `screens/landing/Landing-Mobile-SPEC.html` | `To Delete/Landing.html` |
| `screens/login/Login-Mobile-SPEC.html` | `To Delete/Login.html` |
| `screens/onboarding/Onboarding-Mobile-SPEC.html` | `To Delete/Onboarding.html` |
| `screens/studio/Studio-Compose-Media-SPEC.html` | `To Delete/Studio.html` |
| `screens/studio/Studio-Ideas-SPEC.html` | `To Delete/Studio.html` |
| `screens/studio/Studio-Schedule-SPEC.html` | `To Delete/Studio.html` |
| `screens/studio/Studio-Thread-SPEC.html` | `To Delete/Studio.html` |
| `screens/calendar/Calendar-Mobile-SPEC.html` | `To Delete/Autopilot.html` |
| `screens/calendar/Calendar-SPEC.html` | `To Delete/Autopilot.html` |
| `screens/feed/Feed-Media-SPEC.html` | `To Delete/Autopilot-SPEC.html` |
| `screens/replies/Replies-Media-SPEC.html` | `To Delete/Replies.html` |
| `screens/mentions/Mentions-Queue-SPEC.html` | `To Delete/Mentions-SPEC.html` |
| `screens/autopilot/Autopilot-Mobile-SPEC.html` | `To Delete/Autopilot-SPEC.html` |
| `screens/autopilot/Autopilot-Unified-SPEC.html` | `To Delete/Scenarios-SPEC.html` |
| `screens/autopilot/Autopilot-Unified-SPEC.html` | `To Delete/Scenario-Editor-SPEC.html` |
| `screens/autopilot/Autopilot-Unified-SPEC.html` | `To Delete/Autopilot-SPEC.html` |
| `screens/explore/Explore-Mobile-SPEC.html` | `To Delete/Explore.html` |
| `screens/style-rules/Style-Rules-Mobile-SPEC.html` | `To Delete/Style Rules.html` |
| `screens/overview/Overview-Cockpit-Mobile-SPEC.html` | `To Delete/Overview-Mobile-SPEC.html` |
| `screens/overview/Overview-Cockpit-SPEC.html` | `To Delete/Overview-SPEC.html` |
| `screens/account-advisor/Account-Advisor-SPEC.html` | `To Delete/Applied-Changes-SPEC.html` |
| `screens/account-settings/Account-Settings-SPEC.html` | `To Delete/Applied-Changes-SPEC.html` |

По смыслу это три вида ссылок, и вычищаются они по-разному:

1. **«Прототип этого экрана»** — 9 ссылок на React-загрузчики (Landing.html, Login.html, Onboarding.html, Studio.html, Autopilot.html, Replies.html, Explore.html, «Style Rules.html»). Строку про прототип можно просто убрать.
2. **«Предыдущее поколение»** — ссылки на Scenarios-SPEC, Scenario-Editor-SPEC, Autopilot-SPEC, Overview-SPEC, Overview-Mobile-SPEC, Mentions-SPEC, Applied-Changes-SPEC. Историческая справка, тоже убирается строкой.
3. **Особый случай — `screens/autopilot/Autopilot-Mobile-SPEC.html`.** Он объявляет своей десктопной парой `Autopilot-SPEC.html`, то есть поколение 2, а не победивший Autopilot-Unified-SPEC. Пара по поколению не сходится. Я не стал переписывать ссылку сам: там в тексте стоит имя файла, а править содержимое документов вы запретили. Это стоит поправить руками — либо перенаправить на Autopilot-Unified-SPEC, либо написать под него новую мобильную спеку.

Плюс `system/Legal Template.html` — 7 ссылок, о нём в разделе выше.
