...
(function () {
  ...
  function sidebar(ctx) {
    ...
    var rows = navRow("dashboard", "grid", tt.dashboard, true) +
      ...
      navRow("advisor", "advisor", tt.advisor, false) +
  ...
  function mobileBottom(ctx) {
    ...
    return "<nav class='vmbottom'>" + b("grid", tt.dashboard, true) +
      ...
      b("advisor", tt.advisor, false) + b("settings", tt.settings, false) + "</nav>";
  }
  ...
  window.VSHELL = { render: render, picker: picker, switcher: switcher, wire: wire, nib: nib };
