...
(function () {
  ...
  var T = {
    ru: {
      account: "Аккаунт", dashboard: "Дашборд", brands: "Бренды", advisor: "Агент",
      ...
      advTitle: "Агент аккаунта", advScope: "По всему портфелю", advBasis: "На основе",
      advAsk: "Спросите о портфеле…", advOpen: "Открыть Агента", advReco: "Рекомендации",
  ...
  var ADVISOR = {
    ...
    off: {
      ...
      body: {
        ru: "Аккаунт и данные на месте — это не выход из системы. Переподключи хотя бы один профиль, и Агент снова даст вывод по портфелю. Голоса и история сохранены.",
