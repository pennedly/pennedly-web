/* account/advisor-spec.js — populates Account-Advisor-SPEC.html (desktop).
   ...
   dashboard (ask row / starter / «Открыть Агента»), never from a menu — the
   «Агент» nav item is gone. So the chat keeps its exact body (account-screens.js
   .adv-* vocabulary — NO redesign) but swaps the old «Агент»-active sidebar
...
(function () {
  ...
  X.set("f-seeded", stack(
    col("Светлая · момент входа: засеянный вопрос + Агент генерирует", deepScreen(LANG, false, "thinking", true), false, "frame--pad14"),
