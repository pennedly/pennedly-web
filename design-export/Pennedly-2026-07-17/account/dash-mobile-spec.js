/* account/dash-mobile-spec.js — populates Account-Dashboard-Mobile-SPEC.html.
   ...
   with top bar + bottom bar, no «Советник» tab). Proves Rule 1 down to 320. */
(function () {
  "use strict";
  ...
  /* ── §4 chrome: top bar + bottom bar (no «Советник» tab) + account sheet ── */
  SK.set("f-chrome", "<div class='frame frame--phones'>" +
    SK.phoneCol("Нижний бар: Дашборд · Бренды · Настройки — без «Советника»", { scn: "two_brands", lang: L }, 390) +
