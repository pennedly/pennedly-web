...
| 10 | **Voice/role-book** | 🟡 L | Q60 интерим-фикс ✅ (`flattenSections`) · Q67 ✅ — hero «Analyzed N posts · Updated <date>» из `posts_analyzed`+`activated_at` (v<id>/parent убраны) · Q23 ✅ — GET 404 → `EmptyVoice` с «Extract my voice». Осталось (полный типизированный редактор): **Q60 (правка объектов с вторичными полями: note/text/context + стабильные ids)** · Q8 перевод по секциям · Q16 Post/Reply context на примерах |
