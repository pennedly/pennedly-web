/* account/v3.js — PRODUCTION build of the chosen concept V3 "Агент"
   ...
   • No "Агент" nav item — the dashboard is the advisor's home.
   • The ask line + "Открыть Агента" DON'T expand a chat inline: they route to
...
(function () {
  ...
  var S3 = {
    ru: {
      ...
      tryAsk: "Например", askHint: "Вопрос откроет чат-Агента",
  ...
  window.V3 = {
    render: render, name: { ru: "Агент", de: "Berater" },
