    ...
    <>
      ...
      {open && (
        <div className="acct-menu" role="menu">
          <a className="acct-row acct-row--all" role="menuitem" href="Overview.html">
            <span className="acct-all-ico"><window.IcOverview size={17} /></span>
            <span className="who"><span className="nm">All accounts</span><span className="hd">{accounts.length} connected · Overview</span></span>
            <window.IcChevDown size={15} className="acct-all-chev" style={{ transform: "rotate(-90deg)" }} />
          </a>
