...
const PATTERNS = [
  {
    ...
    evidence: {
      lead: { label: "Opens with a question", value: 34, display: "34 avg comments" },
      base: { label: "Opens with a statement", value: 16, display: "16 avg comments" },
    },
  ...
  },
  {
    ...
    evidence: {
      lead: { label: "Under 120 characters", value: 24600, display: "24.6K avg views" },
      base: { label: "Over 120 characters", value: 14200, display: "14.2K avg views" },
    },
  ...
  },
  {
    ...
    evidence: {
      lead: { label: "Craft & revision", value: 412, display: "412 avg likes" },
      base: { label: "Motivation & mindset", value: 218, display: "218 avg likes" },
    },
  ...
  },
  {
    ...
    evidence: {
      lead: { label: "Tue 8–10am", value: 28100, display: "28.1K avg views" },
      base: { label: "All other slots", value: 17300, display: "17.3K avg views" },
    },
