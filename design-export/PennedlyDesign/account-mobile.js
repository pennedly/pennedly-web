...
(function () {
  ...
  function navDrawer(lang, opts) {
    ...
    var rows = navRow("grid", t.navDashboard, true);
    if (multi) rows += navRow("layers", t.navBrands, false, opts.brandsCount);
    rows += navRow("advisor", t.navAdvisor, false);
    rows += navRow("settings", t.navSettings, false);
