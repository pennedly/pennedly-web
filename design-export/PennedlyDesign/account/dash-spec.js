...
(function () {
  ...
  /* ── §8 thin (204) ── */
  SK.set("f-thin", stack(
    SK.col("Светлая · Агент отдал 204 → приглашение + стартеры", piece(V3.thinHero(rOne, L)), false),
  ...
  SK.set("f-one", stack(
    SK.col("Светлая · 1 бренд · 1 профиль (новый пользователь · Агент 204)", SK.stage({ scn: "one_profile", lang: L }), false, "frame--pad14"),
